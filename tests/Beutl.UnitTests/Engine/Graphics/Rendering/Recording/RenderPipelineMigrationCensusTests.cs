...
public sealed class RenderPipelineMigrationCensusTests
{
    ...
    private static readonly IReadOnlyDictionary<string, int> s_testOverrideBaseline =
        new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["tests/Beutl.UnitTests/Engine/Graphics/Rendering/Cache/ContainerTopologyCacheInvalidationTests.cs"] = 1,
            ...
            ["tests/Beutl.UnitTests/Engine/Graphics/Rendering/Recording/DeclaredSlotBindingRefusalTests.cs"] = 1,
    ...
    public void ProcessOverrideInventory_PinsStartingBaselineAndMigratedOverrides()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            AssertBaselineInventory("test", 262, s_testOverrideBaseline, overrides);
        }
    }
