...
public sealed class RenderPipelineMigrationCensusTests
{
    ...
    private static readonly IReadOnlyDictionary<string, int> s_testOverrideBaseline =
        new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["tests/Beutl.PublicApiContractTests/RenderScaleMappingContractTests.cs"] = 5,
            ...
            ["tests/Beutl.UnitTests/Engine/Graphics/Rendering/HitTestDomainAgreementTests.cs"] = 1,
            ...
            ["tests/Beutl.UnitTests/Engine/Graphics/Rendering/SlotBackedHitTestTests.cs"] = 1,
    ...
    public void ProcessOverrideInventory_PinsStartingBaselineAndMigratedOverrides()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            AssertBaselineInventory("test", 197, s_testOverrideBaseline, overrides);
        }
    }
