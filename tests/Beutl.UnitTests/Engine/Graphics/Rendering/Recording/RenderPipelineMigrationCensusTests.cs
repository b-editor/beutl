...
public sealed class RenderPipelineMigrationCensusTests
{
    ...
    private static readonly IReadOnlyDictionary<string, int> s_testOverrideBaseline =
        new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["tests/Beutl.PublicApiContractTests/OrphanedTargetEffectContractTests.cs"] = 1,
            ...
            ["tests/Beutl.UnitTests/Engine/Graphics/Rendering/Cache/RenderCacheVerificationTests.cs"] = 2,
    ...
    public void ProcessOverrideInventory_PinsStartingBaselineAndMigratedOverrides()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            AssertBaselineInventory("test", 188, s_testOverrideBaseline, overrides);
        }
    }
