...
public sealed class InTreeDeclaredTraitTests
{
    ...
    [Test]
    public void TextDeclaresDeviceGridPhaseDependenceWhileTheOtherVectorSourcesDoNot()
    {
        Assert.Multiple(() =>
        {
            Assert.That(
    ...
    [TestCase(false, TransformOperator.Prepend, false, false)]
    public void TransformOverASource_BypassesOnlyDeviceGridSensitiveContentUnderARemappingScope(
        bool useText,
        TransformOperator transformOperator,
        bool identityMatrix,
        bool expectBypass)
