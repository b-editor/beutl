...
// US1 / T026: Skia-filter-mode effects (Blur etc.) scale via the root CTM. Empirically checks that
// the inline path produces faithful reduced-scale output for a blurred shape.
[NonParallelizable]
[TestFixture]
