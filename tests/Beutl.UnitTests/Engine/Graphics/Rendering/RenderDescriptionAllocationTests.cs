...
public sealed class RenderDescriptionAllocationTests
{
    ...
    // Measured steady state is ~199,300 bytes/frame, leaving about 12% headroom. That headroom is for the
    ...
    private const long SceneBytesPerFrameCeiling = 223_000;

    // The same scene with the render cache warm allocates about 260,500 bytes/frame, leaving about 7%
    ...
    private const long WarmCacheSceneBytesPerFrameCeiling = 279_500;
