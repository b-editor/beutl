...
public sealed class RenderDescriptionAllocationTests
{
    ...
    // Measured steady state is ~179,200 bytes/frame, leaving about 12% headroom. That headroom is for the
    ...
    private const long SceneBytesPerFrameCeiling = 200_500;

    // The same scene with the render cache warm allocates about 240,300 bytes/frame, leaving about 7%
    ...
    private const long WarmCacheSceneBytesPerFrameCeiling = 257_900;
