...
public class SourceVideoSpeedTest
{
    ...
    public void CalculateVideoTime_WithStaticSpeed100_ShouldReturnSameTime()
    {
        ...
        _sourceVideoResource = (SourceVideo.Resource)
            _sourceVideo.ToResource(CompositionContext.Default);
        ...
        Assert.That(
            _sourceVideoResource.RequestedPosition.TotalSeconds,
            Is.EqualTo(1.0).Within(0.1)
        );
    }
    ...
    public void CalculateVideoTime_WithLinearSpeedAnimation_ShouldInterpolateSmoothly()
    {
        ...
        animation.KeyFrames.Add(
            new KeyFrame<float> { Value = 200f, KeyTime = TimeSpan.FromSeconds(2) }
        );
    ...
    public void CalculateVideoTime_WithLinearSpeedAnimation_AtMidpoint_ShouldInterpolateCorrectly()
    {
        ...
        animation.KeyFrames.Add(new KeyFrame<float> { Value = 100f, KeyTime = TimeSpan.Zero });
        animation.KeyFrames.Add(
            new KeyFrame<float> { Value = 300f, KeyTime = TimeSpan.FromSeconds(4) }
        );
        _sourceVideo!.Speed.Animation = animation;
    ...
    public void CalculateVideoTime_WithConstantSpeedAnimation_ShouldMatchStaticSpeed()
    {
        ...
        animation.KeyFrames.Add(
            new KeyFrame<float> { Value = 150f, KeyTime = TimeSpan.FromSeconds(10) }
        );
        _sourceVideo!.Speed.Animation = animation;
    ...
    public void CalculateVideoTime_SequentialUpdates_ShouldUseCacheEfficiently()
    {
        ...
        animation.KeyFrames.Add(new KeyFrame<float> { Value = 100f, KeyTime = TimeSpan.Zero });
        animation.KeyFrames.Add(
            new KeyFrame<float> { Value = 200f, KeyTime = TimeSpan.FromSeconds(10) }
        );
        _sourceVideo!.Speed.Animation = animation;
    ...
    public void CalculateVideoTime_WithVerySmallTimeSpan_ShouldHandleCorrectly()
    {
        ...
        Assert.That(
            _sourceVideoResource.RequestedPosition.TotalMilliseconds,
            Is.EqualTo(2.0).Within(0.5)
        );
    }
    ...
    public void CalculateVideoTime_OffsetElement_UseGlobalClockTrue_ShouldStartFromElementZero()
    {
        ...
        animation.KeyFrames.Add(new KeyFrame<float> { Value = 100f, KeyTime = TimeSpan.Zero });
        animation.KeyFrames.Add(
            new KeyFrame<float> { Value = 100f, KeyTime = TimeSpan.FromSeconds(15) }
        );
        _sourceVideo.Speed.Animation = animation;
    ...
    public void CalculateVideoTime_OffsetElement_UseGlobalClockTrue_WithVariableSpeed_ShouldAccumulateFromElementStart()
    {
        ...
        animation.KeyFrames.Add(new KeyFrame<float> { Value = 100f, KeyTime = TimeSpan.Zero });
        animation.KeyFrames.Add(
            new KeyFrame<float> { Value = 200f, KeyTime = TimeSpan.FromSeconds(15) }
        );
        _sourceVideo.Speed.Animation = animation;
