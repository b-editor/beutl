...
public class TimeRangeTests
{
    ...
    public void Union()
    {
        ...
        Assert.That(range1.Union(range2), Is.EqualTo(TimeRange.FromSeconds(7)));
        Assert.That(range2.Union(range3), Is.EqualTo(TimeRange.FromSeconds(2, 8)));
    }
    ...
    public void Intersect()
    {
        ...
        Assert.That(range1.Intersect(range2), Is.EqualTo(TimeRange.FromSeconds(2, 3)));
        Assert.That(range2.Intersect(range3), Is.EqualTo(TimeRange.FromSeconds(5, 2)));
    }
    ...
    public void Intersects()
    {
        ...
        Assert.That(range1.Intersects(range2), Is.EqualTo(true));
        Assert.That(range2.Intersects(range1), Is.EqualTo(true));
        Assert.That(range1.Intersects(range3), Is.EqualTo(false));
        Assert.That(range3.Intersects(range1), Is.EqualTo(false));
    }
