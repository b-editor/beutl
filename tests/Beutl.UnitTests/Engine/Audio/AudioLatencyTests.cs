...
internal sealed partial class FixedLatencyEffect : AudioEffect
{
    private readonly int _latencySamples;

    public FixedLatencyEffect(int latencySamples)
    {
    ...
    public override int GetLatencySamples(int sampleRate) => _latencySamples;
}
