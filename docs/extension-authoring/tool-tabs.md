...
- When reused content implements `IDisposable`, the dock host disposes it before its `IToolContext`. Make disposal idempotent and do not share externally owned resources with the view or add a ViewModel event solely to dispose the view.
