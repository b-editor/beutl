...
- **Input**: `{ "timeSeconds"?: number[], "sampleCount"?: number, "renderScale"?: number, "styleProfile"?: string, "allowAllCaps"?: bool, "allowHardCuts"?: bool, "allowRectDominance"?: bool, "relaxAesthetics"?: bool, "allowStillness"?: bool, "allowDenseText"?: bool, "allowMultiObjectElements"?: bool, "allowMonochrome"?: bool, "allowMinimalDensity"?: bool, "plannedForegroundElementsPerShot"?: number, "staticLayout"?: bool }`. When `timeSeconds` is omitted, the tool samples evenly across the scene duration. `plannedForegroundElementsPerShot` is the `quantitativePlanSheet` density target; when it is `> 0`, motion-graphics authored density below half of that target can produce a Major `layerDensity` issue unless `allowMinimalDensity` or a minimal/negative-space role tag is present. `staticLayout=true` is the storyboard-phase gate: it skips rendered-motion checks (`evaluateMotion=false`) so a motionless storyboard is judged on composition, typography, density, palette, background richness, and structure only — no Major `motionContinuity` blocker.
...
- **Input**: same intent/profile flags as `evaluate_edit_quality`, except render sampling is omitted. `plannedForegroundElementsPerShot` can be supplied for document-only density plan checks.
...
- **Input**: `{ "includeMotion"?: bool, "timeSeconds"?: number[], "sampleCount"?: number, "renderScale"?: number, "styleProfile"?: string, "requireAnimatedProperties"?: bool, "allowAllCaps"?: bool, "allowHardCuts"?: bool, "allowRectDominance"?: bool, "relaxAesthetics"?: bool, "allowStillness"?: bool, "allowDenseText"?: bool, "allowMultiObjectElements"?: bool, "allowMonochrome"?: bool, "allowMinimalDensity"?: bool, "plannedForegroundElementsPerShot"?: number }`.
