...
- [x] T008 [P] Document round-trip test in `tests/Beutl.AgentToolkit.Tests/Documents/DocumentRoundTripTests.cs` — serialize → normalize → de-normalize → re-serialize preserves 100% of content incl. unrecognized keys (FR-013/SC-003)
