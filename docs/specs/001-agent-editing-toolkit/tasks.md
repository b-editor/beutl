...
- [x] T042 [P] [US2] Implement the keyframe assists `add_keyframe`/`update_keyframe`/`remove_keyframe` in `src/Beutl.AgentToolkit/Tools/KeyframeTools.cs` (shared core surface) (FR-008; contracts/mcp-tools.md)
