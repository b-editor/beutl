...
## Technical Context
C#/.NET 10, Avalonia 11.3.17, NativeWebView 11.4.1, FluentAvalonia 2.5.1, NUnit. Existing browser code stays inside Beutl.Editor.Components; no public API or dependency changes.
...
- Download completion appends metadata only after the file exists; download-history actions reuse the downloader and IElementAdder.
