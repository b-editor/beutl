...
- [X] T090 [US4] Compute first/last-use intervals, exact target reuse, fan-out lifetimes, peak-live accounting, and cache-transfer discharge in `src/Beutl.Engine/Graphics/Rendering/Planning/ResourcePlanUseSchedule.cs` and `src/Beutl.Engine/Graphics/Rendering/Planning/RenderRequestExecutor.cs`
