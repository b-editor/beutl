...
- [X] T117 [P] Update filter-effect authoring guidance for `ApplyTo`, Shader, Geometry, opaque fallbacks, and the removed executable API in `.claude/skills/beutl-filter-effect/SKILL.md` and `docs/ai-workflow/resolution-independent-rendering.md`
