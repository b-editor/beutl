...
- [X] T088 [P] [US4] Add program-cache byte/LRU/device eviction, re-entrant lease safety, runtime reset, and full source/signature equality to `src/Beutl.Engine/Graphics/Rendering/Planning/ProgramCache.cs`
