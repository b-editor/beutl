...
5. When the API lands, update the public filter-effect authoring documentation so it teaches Shader/Geometry recording and deferred custom-scale declarations instead of eager `Process` allocation.
