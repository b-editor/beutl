...
3. Use compiler liveness only to schedule reuse and bound the number of simultaneously leased intermediates. Do not reserve planned allocations, simulate a request-wide byte/target admission budget, or install a second allocation preflight before execution.
