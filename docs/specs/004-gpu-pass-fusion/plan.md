...
5. Add deterministic tests for invalid/overflowed sizes, backend dimensions smaller than 16,384, dynamic expansion, Preview degradation, Delivery failure, stale/double lease release, and cleanup after primary and cleanup exceptions.
