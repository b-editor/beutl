...
│   ├── ShaderDefinitionCalls.cs        # public ShaderDefinition/ShaderCall authoring seam
│   ├── ShaderDescription.cs            # engine-internal lowered form
│   ├── SkslSource.cs
│   ├── ShaderBindings.cs
│   ├── GeometryDefinitionCalls.cs      # public GeometryDefinition/GeometryCall authoring seam
│   ├── GeometryDescription.cs          # engine-internal lowered form
│   └── GeometrySession.cs
├── Rendering/
│   ├── RenderNode.cs
...
│   │   └── RenderDefinitionCalls.cs    # Opaque/TargetScope/TargetCommand/RawTarget definitions and calls
│   ├── Planning/
