...
- [X] T062 [P] Document `iScale` (SKSL; **no `uScale`** — GLSL derives the working scale from device-px `Width`/`Height`) + the working-scale shader contract for authors in `docs/ai-workflow/` (reference `contracts/shader-uniforms.md`)
