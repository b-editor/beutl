...
- Filter effects: implement `FilterEffect.Describe(EffectGraphBuilder, Resource)` and append declarative descriptors through `EffectGraphBuilder`; see `docs/specs/004-gpu-pass-fusion/contracts/breaking-changes.md` for the removed imperative API migration.
