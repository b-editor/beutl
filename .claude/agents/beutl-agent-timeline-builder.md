...
- For multi-element motion graphics, plan/apply/save in small stages that map to the chosen `conceptPlan.elementPlan`; do not start with one huge full-scene patch.
