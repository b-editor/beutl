...
namespace BEditor.Core.SDL2 {
    public static partial class SDL {
        public static class TTF {
            #region SDL2# Variables

            /* Used by DllImport to load the native library. */
            private const string nativeLibName = "Runtimes\\SDL2_ttf";
            ...
            public static void Version(out SDL_version X) {
            ...
            public static SDL_version TTF_LinkedVersion() {
            ...
            private static extern unsafe IntPtr INTERNAL_TTF_OpenFont(byte* file, int ptsize);
            public static unsafe IntPtr OpenFont(string file, int ptsize) {
            ...
            private static extern unsafe IntPtr INTERNAL_TTF_OpenFontIndex(byte* file, int ptsize, long index);
            public static unsafe IntPtr OpenFontIndex(string file, int ptsize, long index) {
                byte* utf8File = SDL.Utf8Encode(file);
            ...
            public static extern IntPtr OpenFontIndexRW(IntPtr src, int freesrc, int ptsize, long index);

            /* font refers to a TTF_Font*
             * Only available in 2.0.16 or higher.
             */
            [DllImport(nativeLibName, EntryPoint = "TTF_SetFontSize", CallingConvention = CallingConvention.Cdecl)]
            public static extern int SetFontSize(IntPtr font, int ptsize);
            ...
            public static extern int GetFontHinting(IntPtr font);

            /* font refers to a TTF_Font* */
            [DllImport(nativeLibName, EntryPoint = "TTF_SetFontHinting", CallingConvention = CallingConvention.Cdecl)]
            public static extern void SetFontHinting(IntPtr font, int hinting);
