...
{
    private static bool WindowsIsClickDown() => User32.GetKeyState(User32.VK_LBUTTON) < 0;

    private static bool WindowsIsEscapeDown() => User32.GetKeyState(User32.VK_ESCAPE) < 0;
