...
public abstract class PropertyEditorValueChangedEventArgs : RoutedEventArgs
{
    ...
    protected PropertyEditorValueChangedEventArgs(RoutedEvent routedEvent, object source)
...
public class PropertyEditorValueChangedEventArgs<TValue> : PropertyEditorValueChangedEventArgs
{
    ...
    public PropertyEditorValueChangedEventArgs(TValue newValue, TValue oldValue, RoutedEvent routedEvent, object source)
        : base(routedEvent, source)
    {
        NewValue = newValue;
        OldValue = oldValue;
