...
namespace Beutl.Controls.Generators;

public class BcTabItemContainerGenerator : ItemContainerGenerator<BcTabItem>
{
    public BcTabItemContainerGenerator(BcTabView owner,
    ...
    {
        var tabItem = (BcTabItem)CreateContainer<BcTabItem>(item);
