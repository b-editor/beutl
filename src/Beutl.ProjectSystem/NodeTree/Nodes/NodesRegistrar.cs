...
public static class NodesRegistrar
{
    public static void RegisterAll()
    {
        ...
        NodeRegistry.RegisterNode<GeometryShapeNode>(GraphicsStrings.GeometryShape, Colors.ForestGreen);
        NodeRegistry.RegisterNode<TextNode>(GraphicsStrings.TextBlock, Colors.ForestGreen);
        NodeRegistry.RegisterNode<TransformNode>(GraphicsStrings.Transform, Colors.MediumPurple);
        ...
        NodeRegistry.RegisterNodes(GraphicsStrings.FilterEffect, Colors.DodgerBlue)
        ...
        NodeRegistry.RegisterNodes(GraphicsStrings.Brush, Colors.Orange)
