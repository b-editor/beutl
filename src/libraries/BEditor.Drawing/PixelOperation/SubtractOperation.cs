...
{
    /// <summary>
    /// Subtracts and combine the pixels.
    /// </summary>
        ...
        where T : unmanaged, IPixel<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubtractOperation{T}"/> struct.
        /// </summary>
        ...
        public SubtractOperation(T* src1, T* src2, T* dst)
        {
            _src1 = src1;
            _src2 = src2;
            _dst = dst;
        ...
        {
            _dst[pos] = _src1[pos].Subtract(_src2[pos]);
        }
    }
}