...
namespace BEditor.Graphics.OpenGL
{
    ...
    public unsafe sealed class GraphicsContextImpl : IGraphicsContextImpl
    {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="GraphicsContextImpl"/> class.
        /// </summary>
        ~GraphicsContextImpl()
        {
        ...
        public void DrawTexture(Texture texture)
        {
            ...
            var impl = (TextureImpl)texture.PlatformImpl;
        ...
        public void DrawCube(Cube cube)
        {
            ...
            MakeCurrentAndBindFbo();
            var impl = (CubeImpl)cube.PlatformImpl;
        ...
        public void DrawBall(Ball ball)
        {
            ...
            MakeCurrentAndBindFbo();
            var impl = (BallImpl)ball.PlatformImpl;
        ...
        public void DrawLine(Line line)
        {
            ...
            MakeCurrentAndBindFbo();
            var impl = (LineImpl)line.PlatformImpl;
        ...
        private void DrawTextureWithLight(TextureImpl texture)
        {
            if (texture is null) throw new ArgumentNullException(nameof(texture));
            MakeCurrentAndBindFbo();
        ...
        private void DrawCubeWithLight(CubeImpl cube)
        {
            if (cube is null) throw new ArgumentNullException(nameof(cube));
            _lightShader.Use();
        ...
        private void DrawBallWithLight(BallImpl ball)
        {
            if (ball is null) throw new ArgumentNullException(nameof(ball));
            _lightShader.Use();
