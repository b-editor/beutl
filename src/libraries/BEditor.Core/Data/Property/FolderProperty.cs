...
namespace BEditor.Data.Property
{
    ...
    public class FolderProperty : PropertyElement<FolderPropertyMetadata>, IEasingProperty, IBindable<string>
    {
        ...
        [Pure]
        public IRecordCommand ChangeFolder(string path)
        {
            return new ChangeFolderCommand(this, path);
        }
        ...
        private sealed class ChangeFolderCommand : IRecordCommand
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ChangeFolderCommand"/> class.
            /// </summary>
            ...
            public string Name => Strings.ChangeFolder;
