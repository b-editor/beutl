...
public static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor UnmarkedRenderNodeMutation = new(
        ...
        messageFormat:
            ...
            + "assignment written inside '{0}' or a type it inherits from - to the state itself or to an "
            + "element of it - and the "
        ...
        description:
            ...
            + "The first is an assignment: a member of the node's own type, or of a type it inherits "
