...
public readonly record struct ValuePropertyInfo(
    ...
    bool ExcludeFromResource
);

public readonly record struct ObjectPropertyInfo(
    string Name,
...
public readonly record struct ListPropertyInfo(
    string Name,
...
public readonly record struct NodePortPropertyInfo(
    string Name,
    ITypeSymbol ValueType,
    NodePortKind Kind
);
