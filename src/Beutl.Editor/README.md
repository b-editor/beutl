# Beutl.Editor contributor guide
...
Unit tests for this subtree live in `tests/Beutl.UnitTests/Editor*/` (NUnit). Add matching coverage whenever a new operation or service is introduced.
