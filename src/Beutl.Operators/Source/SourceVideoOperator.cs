...
public sealed class DrawableVideoOperator() : PublishOperator<DrawableVideo>(
[
    (DrawableVideo.OffsetPositionProperty, TimeSpan.Zero),
    (DrawableVideo.SpeedProperty, 100f),
    DrawableVideo.SourceProperty,
    (Drawable.TransformProperty, () => new TransformGroup()),
    Drawable.AlignmentXProperty,
    Drawable.AlignmentYProperty,
    Drawable.TransformOriginProperty,
