    ...
    public static void RegisterDefaultReceiver<T>(ItemValue<T> itemValue, IModifiableHierarchical hierarchical)
    {
        switch (itemValue)
        {
            ...
            case ItemValue<Transform?> ts:
                ...
                break;
            case ItemValue<Thickness> thicknessNodePort:
                thicknessNodePort.AcceptNumber();
                break;
            case ItemValue<Vector> vectorNodePort:
                vectorNodePort.AcceptNumber();
                break;
            case ItemValue<Point> pointNodePort:
                pointNodePort.AcceptNumber();
                break;
            case ItemValue<Size> sizeNodePort:
                sizeNodePort.AcceptNumber();
                break;
            case ItemValue<Rect> rectNodePort:
                rectNodePort.AcceptNumber();
                break;
            case ItemValue<PixelPoint> pixelPointNodePort:
                pixelPointNodePort.AcceptNumber();
                break;
            case ItemValue<PixelSize> pixelSizeNodePort:
                pixelSizeNodePort.AcceptNumber();
                break;
            case ItemValue<PixelRect> pixelRectNodePort:
                pixelRectNodePort.AcceptNumber();
                break;
            case ItemValue<float> floatNodePort:
                floatNodePort.AcceptNumber();
                break;
            case ItemValue<double> doubleNodePort:
                doubleNodePort.AcceptNumber();
                break;
            case ItemValue<int> intNodePort:
                intNodePort.AcceptNumber();
                break;
            case ItemValue<long> longNodePort:
                longNodePort.AcceptNumber();
                break;
            case ItemValue<short> shortNodePort:
                shortNodePort.AcceptNumber();
                break;
            case ItemValue<byte> byteNodePort:
                byteNodePort.AcceptNumber();
                break;
            case ItemValue<sbyte> sbyteNodePort:
                sbyteNodePort.AcceptNumber();
                break;
            case ItemValue<uint> uintNodePort:
                uintNodePort.AcceptNumber();
                break;
            case ItemValue<ulong> ulongNodePort:
                ulongNodePort.AcceptNumber();
                break;
            case ItemValue<ushort> ushortNodePort:
                ushortNodePort.AcceptNumber();
                break;
            case ItemValue<nint> nintNodePort:
                nintNodePort.AcceptNumber();
                break;
            case ItemValue<nuint> nuintNodePort:
                nuintNodePort.AcceptNumber();
                break;
            case ItemValue<Half> halfNodePort:
                halfNodePort.AcceptNumber();
                break;
            case ItemValue<decimal> decimalNodePort:
                decimalNodePort.AcceptNumber();
                break;
            case ItemValue<Int128> int128NodePort:
                int128NodePort.AcceptNumber();
                break;
