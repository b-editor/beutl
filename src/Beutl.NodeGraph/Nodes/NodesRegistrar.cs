...
public static class NodesRegistrar
{
    public static void RegisterAll()
    {
        ...
        GraphNodeRegistry.RegisterNode<GeometryShapeNode>(
            GraphicsStrings.GeometryShape,
            Colors.ForestGreen
        );
        GraphNodeRegistry.RegisterNode<TextNode>(GraphicsStrings.TextBlock, Colors.ForestGreen);
        GraphNodeRegistry.RegisterNode<ImageSourceNode>(
            GraphicsStrings.SourceImage,
            Colors.ForestGreen
        );
        GraphNodeRegistry.RegisterNode<VideoSourceNode>(
            GraphicsStrings.SourceVideo,
            Colors.ForestGreen
        );
        GraphNodeRegistry.RegisterNode<TransformNode>(
            GraphicsStrings.Transform,
            Colors.MediumPurple
        );

        GraphNodeRegistry
            .RegisterNodes("Geometry", Colors.ForestGreen)
        ...
        GraphNodeRegistry
            .RegisterNodes("Group", Colors.Gold)
        ...
        GraphNodeRegistry
            .RegisterNodes(GraphicsStrings.FilterEffect, Colors.DodgerBlue)
            ...
            .AddGroup(
                ...
                o =>
                    o.Add<FilterEffectNode<CSharpScriptEffect>>(GraphicsStrings.CSharpScriptEffect)
        ...
        GraphNodeRegistry
            .RegisterNodes(GraphicsStrings.Brush, Colors.Orange)
        ...
        GraphNodeRegistry
            ...
            .AddGroup(
                "Matrix",
                o =>
                    o.Add<Utilities.TranslateMatrixNode>("Translate")
            ...
            .AddGroup(
                "Random",
                o =>
                    o.Add<Utilities.RandomSingleNode>("Random Float")
            ...
            .AddGroup(
                "Struct",
                o =>
                    o.Add<Utilities.Struct.PointNode>("Point")
