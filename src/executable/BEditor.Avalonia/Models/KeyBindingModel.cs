...
namespace BEditor.Models
{
    ...
    public sealed class KeyBindingModel
    {
        ...
        {
            var file = Path.Combine(AppContext.BaseDirectory, "user", "keybindings.json");
            if (!File.Exists(file))
            {
        ...
        {
            using var reader = new StreamWriter(Path.Combine(AppContext.BaseDirectory, "user", "keybindings.json"));
