...
public static class Cursors
{
    ...
    {
        using (
            Stream handStream = AssetLoader.Open(
                new("avares://Beutl.Controls/Assets/cursor-hand.png")
            )
        )
        using (
            Stream grabStream = AssetLoader.Open(
                new("avares://Beutl.Controls/Assets/cursor-hand-grab.png")
            )
        )
        {
