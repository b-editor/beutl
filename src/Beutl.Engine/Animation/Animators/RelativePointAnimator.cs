...
public sealed class RelativePointAnimator : Animator<RelativePoint>
{
    ...
    public override RelativePoint Interpolate(
        float progress,
        RelativePoint oldValue,
        RelativePoint newValue
    )
    {
        ...
        return new RelativePoint(
            s_pointAnimator.Interpolate(progress, oldValue.Point, newValue.Point),
            oldValue.Unit
        );
    }
}
