...
public sealed class MatrixConverter : TypeConverter
{
    ...
    {
        return sourceType == typeof(float[]) || sourceType == typeof(string);
    }
    ...
    {
        return destinationType == typeof(float[]) || base.CanConvertTo(context, destinationType);
    }
    ...
    {
        if (value is Matrix matrix && destinationType == typeof(float[]))
        {
            return new float[]
            {
                matrix.M11,
