...
[Display(
    Name = nameof(GraphicsStrings.WaveformShape_Block),
...
public sealed partial class BlockWaveformShape : WaveformShape
{
    ...
    [Display(
        Name = nameof(GraphicsStrings.WaveformShape_BlockCount),
        ResourceType = typeof(GraphicsStrings)
    )]
    [Range(1, 128)]
    ...
    [Display(
        Name = nameof(GraphicsStrings.WaveformShape_BlockGap),
        ResourceType = typeof(GraphicsStrings)
    )]
    [Range(0f, 50f)]
        ...
        )
        {
            ...
            if (mirrored)
            {
                ...
                float blockHeight = MathF.Max(
                    0.5f,
                    (halfHeight - blockGap * (blockCount - 1)) / blockCount
                );
            ...
            else
            {
                ...
                float blockHeight = MathF.Max(
                    0.5f,
                    (height - blockGap * (blockCount - 1)) / blockCount
                );
