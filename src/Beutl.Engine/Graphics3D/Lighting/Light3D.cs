...
public abstract partial class Light3D : EngineObject
{
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.Light3D_Intensity),
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.Light3D_CastsShadow),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.Light3D_ShadowBias),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.Light3D_ShadowNormalBias),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.Light3D_ShadowStrength),
        ResourceType = typeof(GraphicsStrings)
    )]
