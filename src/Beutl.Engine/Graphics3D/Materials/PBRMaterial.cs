...
/// </summary>
[Display(Name = nameof(GraphicsStrings.PBRMaterial), ResourceType = typeof(GraphicsStrings))]
public sealed partial class PBRMaterial : Material3D
{
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_Albedo),
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_AlbedoMap),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_Metallic),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_Roughness),
        ResourceType = typeof(GraphicsStrings)
    )]
    [Range(0f, 1f), NumberStep(0.1, 0.01)]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_MetallicRoughnessMap),
        ResourceType = typeof(GraphicsStrings)
    )]
    public IProperty<TextureSource?> MetallicRoughnessMap { get; } =
        Property.Create<TextureSource?>(null);

    /// <summary>
    /// Gets the ambient occlusion factor.
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_AmbientOcclusion),
        ResourceType = typeof(GraphicsStrings)
    )]
    [Range(0f, 1f), NumberStep(0.1, 0.01)]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_AOMap),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_Emissive),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_EmissiveIntensity),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_EmissiveMap),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_NormalMap),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.PBRMaterial_NormalMapStrength),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    public partial class Resource
    {
        ...
        )
        {
            ...
            _descriptorSet.UpdateTexture(
                3,
                metallicRoughnessTex ?? _defaultWhiteTexture!,
                _sampler
            );
