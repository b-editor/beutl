...
public sealed partial class BasicMaterial : Material3D
{
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.BasicMaterial_DiffuseColor),
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.BasicMaterial_DiffuseMap),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.BasicMaterial_AmbientColor),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.BasicMaterial_SpecularColor),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.BasicMaterial_Shininess),
        ResourceType = typeof(GraphicsStrings)
    )]
    [Range(1f, 256f)]
