...
/// </summary>
[Display(
    Name = nameof(GraphicsStrings.TransparentMaterial),
...
public sealed partial class TransparentMaterial : Material3D
{
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TransparentMaterial_ColorMap),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TransparentMaterial_IndexOfRefraction),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TransparentMaterial_Roughness),
        ResourceType = typeof(GraphicsStrings)
    )]
    [Range(0f, 1f), NumberStep(0.1, 0.01)]
