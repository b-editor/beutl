...
public sealed class LightingPass : GraphicsNode3D
{
    ...
    private void CreateLightingPipeline()
    {
        ...
        _dummyShadowArray = Context.CreateTextureArray(
            1,
            1,
            ShadowManager.MaxShadowMaps2D,
            TextureFormat.Depth32Float
        );
        _dummyShadowCubeArray = Context.CreateTextureCubeArray(
            1,
            ShadowManager.MaxShadowMapsCube,
            TextureFormat.Depth32Float
        );
