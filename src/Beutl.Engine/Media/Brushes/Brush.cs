...
public abstract partial class Brush : EngineObject
{
    ...
    /// </summary>
    [Display(Name = nameof(GraphicsStrings.Brush_Opacity), ResourceType = typeof(GraphicsStrings))]
    [Range(0, 100)]
    ...
    /// </summary>
    [Display(Name = nameof(GraphicsStrings.Brush_Transform), ResourceType = typeof(GraphicsStrings))]
    ...
    /// </summary>
    [Display(Name = nameof(GraphicsStrings.Brush_TransformOrigin), ResourceType = typeof(GraphicsStrings))]
