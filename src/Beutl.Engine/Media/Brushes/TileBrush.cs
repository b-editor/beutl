...
public abstract partial class TileBrush : Brush
{
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TileBrush_AlignmentX),
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TileBrush_AlignmentY),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TileBrush_DestinationRect),
        ResourceType = typeof(GraphicsStrings)
    )]
    public IProperty<RelativeRect> DestinationRect { get; } =
        Property.CreateAnimatable(RelativeRect.Fill);

    /// <summary>
    /// Gets or sets the rectangle of the source image that will be displayed.
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TileBrush_SourceRect),
        ResourceType = typeof(GraphicsStrings)
    )]
    public IProperty<RelativeRect> SourceRect { get; } =
        Property.CreateAnimatable(RelativeRect.Fill);
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TileBrush_Stretch),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </summary>
    [Display(
        Name = nameof(GraphicsStrings.TileBrush_TileMode),
        ResourceType = typeof(GraphicsStrings)
    )]
    ...
    /// </value>
    [Display(
        Name = nameof(GraphicsStrings.TileBrush_BitmapInterpolationMode),
        ResourceType = typeof(GraphicsStrings)
    )]
