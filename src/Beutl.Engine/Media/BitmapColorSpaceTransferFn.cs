...
public readonly struct BitmapColorSpaceTransferFn : IEquatable<BitmapColorSpaceTransferFn>
{
    ...
    public static BitmapColorSpaceTransferFn Linear { get; } =
        FromSK(SKColorSpaceTransferFn.Linear);

    public static BitmapColorSpaceTransferFn TwoDotTwo { get; } =
        FromSK(SKColorSpaceTransferFn.TwoDotTwo);
    ...
    public static BitmapColorSpaceTransferFn Rec2020 { get; } =
        FromSK(SKColorSpaceTransferFn.Rec2020);

    /// <summary>
    /// BT.709 / BT.601 / SMPTE 170M / IEC 61966-2-4 / BT.1361 ECG
    /// </summary>
    public static BitmapColorSpaceTransferFn Bt709 { get; } =
        new()
        {
            G = 1f / 0.45f,
            A = 1f / 1.099f,
    ...
    /// </summary>
    public static BitmapColorSpaceTransferFn Gamma28 { get; } =
        new()
        {
            G = 2.8f,
            A = 1f,
    ...
    /// SMPTE 240M
    /// </summary>
    public static BitmapColorSpaceTransferFn Smpte240M { get; } =
        new()
        {
            G = 1f / 0.45f,
            A = 1f / 1.1115f,
    ...
    /// </summary>
    public static BitmapColorSpaceTransferFn Smpte428 { get; } =
        new()
        {
            G = 2.6f,
    ...
    public static bool operator ==(
        BitmapColorSpaceTransferFn left,
        BitmapColorSpaceTransferFn right
    )
    {
