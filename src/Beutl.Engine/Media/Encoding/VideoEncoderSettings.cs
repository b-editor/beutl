...
public class VideoEncoderSettings : MediaEncoderSettings
{
    ...
    static VideoEncoderSettings()
    {
        ...
        DestinationSizeProperty = ConfigureProperty<PixelSize, VideoEncoderSettings>(
    ...
    [Display(
        Name = nameof(Strings.FrameSize),
        Description = nameof(Strings.FrameSize_Tip),
    ...
    [Display(
        Name = nameof(Strings.FrameRate),
        Description = nameof(Strings.FrameRate_Tip),
        ResourceType = typeof(Strings),
    ...
    [Display(
        Name = nameof(Strings.Bitrate),
        Description = nameof(Strings.Bitrate_Tip),
        ResourceType = typeof(Strings),
    ...
    [Display(
        Name = nameof(Strings.KeyframeRate),
        Description = nameof(Strings.KeyframeRate_Tip),
        ResourceType = typeof(Strings),
