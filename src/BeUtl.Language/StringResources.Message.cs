...
'{1}'");
        ...
        public static IObservable<string> CouldNotOpenFollowingFileWithExtensionObservable => s_couldNotOpenFollowingFileWithExtension ??= "S.Message.CouldNotOpenFollowingFileWithExtension".GetStringObservable(@"Could not open the following file with '{0}'
'{1}'");
        //S.Message.CannotDisplayThisContext
        private static IObservable<string>? s_cannotDisplayThisContext;
        public static IObservable<string> CannotDisplayThisContextObservable => s_cannotDisplayThisContext ??= "S.Message.CannotDisplayThisContext".GetStringObservable("Cannot display this context.");
        //S.Message.CouldNotCreateInstanceOfView
        private static IObservable<string>? s_couldNotCreateInstanceOfView;
        public static IObservable<string> CouldNotCreateInstanceOfViewObservable => s_couldNotCreateInstanceOfView ??= "S.Message.CouldNotCreateInstanceOfView".GetStringObservable("Could not create an instance of View.");
        //S.Message.ContextNotCreated
        private static IObservable<string>? s_contextNotCreated;
        public static IObservable<string> ContextNotCreatedObservable => s_contextNotCreated ??= "S.Message.ContextNotCreated".GetStringObservable("Context not created.");
        //S.Message.EditorContextHasAlreadyBeenCreated
        private static IObservable<string>? s_editorContextHasAlreadyBeenCreated;
        public static IObservable<string> EditorContextHasAlreadyBeenCreatedObservable => s_editorContextHasAlreadyBeenCreated ??= "S.Message.EditorContextHasAlreadyBeenCreated".GetStringObservable("The editor context has already been created.");
        //S.Message.NullWasSpecifiedForEditorContext
        private static IObservable<string>? s_nullWasSpecifiedForEditorContext;
        public static IObservable<string> NullWasSpecifiedForEditorContextObservable => s_nullWasSpecifiedForEditorContext ??= "S.Message.NullWasSpecifiedForEditorContext".GetStringObservable("Null was specified for the editor context.");
    }
}
