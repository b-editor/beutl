...
public static class Resources {
    public static class S {
        public static class Common {
            ...
            public static string MaskType => "S.Common.MaskType".GetStringResource("MaskType");
            ...
            public static string BorderStyle => "S.Common.BorderStyle".GetStringResource("BorderStyle");
            ...
            private static IObservable<string>? _OperationsObservable;
            public static IObservable<string> OperationsObservable => _OperationsObservable ??= "S.Common.Operations".GetStringObservable(global::BeUtl.Language.Resources.S.Common.Operations);
        ...
        public static class Opearations {
            public static string IndexSource => "S.Opearations.Source".GetStringResource("Source");
            private static IObservable<string>? _IndexSourceObservable;
            public static IObservable<string> IndexSourceObservable => _IndexSourceObservable ??= "S.Opearations.Source".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.IndexSource);
            public static string IndexConfigure => "S.Opearations.Configure".GetStringResource("Configure");
            private static IObservable<string>? _IndexConfigureObservable;
            public static IObservable<string> IndexConfigureObservable => _IndexConfigureObservable ??= "S.Opearations.Configure".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.IndexConfigure);
            public static class Source {
                public static string Ellipse => "S.Opearations.Source.Ellipse".GetStringResource("Ellipse");
                private static IObservable<string>? _EllipseObservable;
                public static IObservable<string> EllipseObservable => _EllipseObservable ??= "S.Opearations.Source.Ellipse".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Source.Ellipse);
                public static string Rect => "S.Opearations.Source.Rect".GetStringResource("Rect");
                private static IObservable<string>? _RectObservable;
                public static IObservable<string> RectObservable => _RectObservable ??= "S.Opearations.Source.Rect".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Source.Rect);
                public static string RoundedRect => "S.Opearations.Source.RoundedRect".GetStringResource("Rounded Rect");
                private static IObservable<string>? _RoundedRectObservable;
                public static IObservable<string> RoundedRectObservable => _RoundedRectObservable ??= "S.Opearations.Source.RoundedRect".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Source.RoundedRect);
                public static string Text => "S.Opearations.Source.Text".GetStringResource("Text");
                private static IObservable<string>? _TextObservable;
                public static IObservable<string> TextObservable => _TextObservable ??= "S.Opearations.Source.Text".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Source.Text);
                public static string ImageFile => "S.Opearations.Source.ImageFile".GetStringResource("Image File");
                private static IObservable<string>? _ImageFileObservable;
                public static IObservable<string> ImageFileObservable => _ImageFileObservable ??= "S.Opearations.Source.ImageFile".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Source.ImageFile);
            }
            public static class Configure {
                public static string Alignment => "S.Opearations.Configure.Alignment".GetStringResource("Alignment");
                private static IObservable<string>? _AlignmentObservable;
                public static IObservable<string> AlignmentObservable => _AlignmentObservable ??= "S.Opearations.Configure.Alignment".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Alignment);
                public static string Blend => "S.Opearations.Configure.Blend".GetStringResource("Blend");
                private static IObservable<string>? _BlendObservable;
                public static IObservable<string> BlendObservable => _BlendObservable ??= "S.Opearations.Configure.Blend".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Blend);
                public static string Foreground => "S.Opearations.Configure.Foreground".GetStringResource("Foreground");
                private static IObservable<string>? _ForegroundObservable;
                public static IObservable<string> ForegroundObservable => _ForegroundObservable ??= "S.Opearations.Configure.Foreground".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Foreground);
                public static string OpacityMask => "S.Opearations.Configure.OpacityMask".GetStringResource("Opacity Mask");
                private static IObservable<string>? _OpacityMaskObservable;
                public static IObservable<string> OpacityMaskObservable => _OpacityMaskObservable ??= "S.Opearations.Configure.OpacityMask".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.OpacityMask);
                public static string IndexBrush => "S.Opearations.Configure.Brush".GetStringResource("Brush");
                private static IObservable<string>? _IndexBrushObservable;
                public static IObservable<string> IndexBrushObservable => _IndexBrushObservable ??= "S.Opearations.Configure.Brush".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.IndexBrush);
                public static string IndexImageFilter => "S.Opearations.Configure.ImageFilter".GetStringResource("Image Filter");
                private static IObservable<string>? _IndexImageFilterObservable;
                public static IObservable<string> IndexImageFilterObservable => _IndexImageFilterObservable ??= "S.Opearations.Configure.ImageFilter".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.IndexImageFilter);
                public static string IndexBitmapEffect => "S.Opearations.Configure.BitmapEffect".GetStringResource("Bitmap Effect");
                private static IObservable<string>? _IndexBitmapEffectObservable;
                public static IObservable<string> IndexBitmapEffectObservable => _IndexBitmapEffectObservable ??= "S.Opearations.Configure.BitmapEffect".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.IndexBitmapEffect);
                public static string IndexTransform => "S.Opearations.Configure.Transform".GetStringResource("Transform");
                private static IObservable<string>? _IndexTransformObservable;
                public static IObservable<string> IndexTransformObservable => _IndexTransformObservable ??= "S.Opearations.Configure.Transform".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.IndexTransform);
                public static class Brush {
                    public static string LinearGradientBrush => "S.Opearations.Configure.Brush.LinearGradientBrush".GetStringResource("Linear Gradient Brush");
                    private static IObservable<string>? _LinearGradientBrushObservable;
                    public static IObservable<string> LinearGradientBrushObservable => _LinearGradientBrushObservable ??= "S.Opearations.Configure.Brush.LinearGradientBrush".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Brush.LinearGradientBrush);
                }
                public static class ImageFilter {
                    public static string Blur => "S.Opearations.Configure.ImageFilter.Blur".GetStringResource("Blur");
                    private static IObservable<string>? _BlurObservable;
                    public static IObservable<string> BlurObservable => _BlurObservable ??= "S.Opearations.Configure.ImageFilter.Blur".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.ImageFilter.Blur);
                    public static string DropShadow => "S.Opearations.Configure.ImageFilter.DropShadow".GetStringResource("Drop Shadow");
                    private static IObservable<string>? _DropShadowObservable;
                    public static IObservable<string> DropShadowObservable => _DropShadowObservable ??= "S.Opearations.Configure.ImageFilter.DropShadow".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.ImageFilter.DropShadow);
                }
                public static class BitmapEffect {
                    public static string Blur => "S.Opearations.Configure.BitmapEffect.Blur".GetStringResource("Blur");
                    private static IObservable<string>? _BlurObservable;
                    public static IObservable<string> BlurObservable => _BlurObservable ??= "S.Opearations.Configure.BitmapEffect.Blur".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.BitmapEffect.Blur);
                    public static string InnerShadow => "S.Opearations.Configure.BitmapEffect.InnerShadow".GetStringResource("Inner Shadow");
                    private static IObservable<string>? _InnerShadowObservable;
                    public static IObservable<string> InnerShadowObservable => _InnerShadowObservable ??= "S.Opearations.Configure.BitmapEffect.InnerShadow".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.BitmapEffect.InnerShadow);
                    public static string Border => "S.Opearations.Configure.BitmapEffect.Border".GetStringResource("Border");
                    private static IObservable<string>? _BorderObservable;
                    public static IObservable<string> BorderObservable => _BorderObservable ??= "S.Opearations.Configure.BitmapEffect.Border".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.BitmapEffect.Border);
                }
                public static class Transform {
                    public static string Rotation => "S.Opearations.Configure.Transform.Rotation".GetStringResource("Rotation");
                    private static IObservable<string>? _RotationObservable;
                    public static IObservable<string> RotationObservable => _RotationObservable ??= "S.Opearations.Configure.Transform.Rotation".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Transform.Rotation);
                    public static string Rotation3D => "S.Opearations.Configure.Transform.Rotation3D".GetStringResource("Rotation 3D");
                    private static IObservable<string>? _Rotation3DObservable;
                    public static IObservable<string> Rotation3DObservable => _Rotation3DObservable ??= "S.Opearations.Configure.Transform.Rotation3D".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Transform.Rotation3D);
                    public static string Scale => "S.Opearations.Configure.Transform.Scale".GetStringResource("Scale");
                    private static IObservable<string>? _ScaleObservable;
                    public static IObservable<string> ScaleObservable => _ScaleObservable ??= "S.Opearations.Configure.Transform.Scale".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Transform.Scale);
                    public static string Skew => "S.Opearations.Configure.Transform.Skew".GetStringResource("Skew");
                    private static IObservable<string>? _SkewObservable;
                    public static IObservable<string> SkewObservable => _SkewObservable ??= "S.Opearations.Configure.Transform.Skew".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Transform.Skew);
                    public static string Translate => "S.Opearations.Configure.Transform.Translate".GetStringResource("Translate");
                    private static IObservable<string>? _TranslateObservable;
                    public static IObservable<string> TranslateObservable => _TranslateObservable ??= "S.Opearations.Configure.Transform.Translate".GetStringObservable(global::BeUtl.Language.Resources.S.Opearations.Configure.Transform.Translate);
                }
            }
        }
