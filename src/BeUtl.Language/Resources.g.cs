...
public static class Resources {
    public static class S {
        public static class Common {
            ...
            public static string Internal => "S.Common.Internal".GetStringResource(@"Internal");
            private static IObservable<string>? _InternalObservable;
            public static IObservable<string> InternalObservable => _InternalObservable ??= "S.Common.Internal".GetStringObservable(global::Beutl.Language.Resources.S.Common.Internal);
            public static string External => "S.Common.External".GetStringResource(@"External");
            private static IObservable<string>? _ExternalObservable;
            public static IObservable<string> ExternalObservable => _ExternalObservable ??= "S.Common.External".GetStringObservable(global::Beutl.Language.Resources.S.Common.External);
            public static string ContentType => "S.Common.ContentType".GetStringResource(@"Content Type");
            private static IObservable<string>? _ContentTypeObservable;
            public static IObservable<string> ContentTypeObservable => _ContentTypeObservable ??= "S.Common.ContentType".GetStringObservable(global::Beutl.Language.Resources.S.Common.ContentType);
...
because the new name conflicts with an existing folder.");
            ...
            public static string InvalidURL => "S.Warning.InvalidURL".GetStringResource(@"Invalid URL");
            private static IObservable<string>? _InvalidURLObservable;
            public static IObservable<string> InvalidURLObservable => _InvalidURLObservable ??= "S.Warning.InvalidURL".GetStringObservable(global::Beutl.Language.Resources.S.Warning.InvalidURL);
        }
 ...
 and prevent others from downloading this release.");
        ...
        public static class SettingsPage {
            ...
            public static class CreateAsset {
                public static string Title => "S.SettingsPage.CreateAsset.Title".GetStringResource(@"Upload file");
                private static IObservable<string>? _TitleObservable;
                public static IObservable<string> TitleObservable => _TitleObservable ??= "S.SettingsPage.CreateAsset.Title".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.Title);
                public static string InternalDescription => "S.SettingsPage.CreateAsset.InternalDescription".GetStringResource(@"Upload the file to the b-editor server.");
                private static IObservable<string>? _InternalDescriptionObservable;
                public static IObservable<string> InternalDescriptionObservable => _InternalDescriptionObservable ??= "S.SettingsPage.CreateAsset.InternalDescription".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.InternalDescription);
                public static string InternalExample => "S.SettingsPage.CreateAsset.InternalExample".GetStringResource(@"Example: Lightweight files such as images");
                private static IObservable<string>? _InternalExampleObservable;
                public static IObservable<string> InternalExampleObservable => _InternalExampleObservable ??= "S.SettingsPage.CreateAsset.InternalExample".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.InternalExample);
                public static string ExternalDescription => "S.SettingsPage.CreateAsset.ExternalDescription".GetStringResource(@"The customer uploads the file to an external server
and b-editor maintains the download URL.");
                private static IObservable<string>? _ExternalDescriptionObservable;
                public static IObservable<string> ExternalDescriptionObservable => _ExternalDescriptionObservable ??= "S.SettingsPage.CreateAsset.ExternalDescription".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.ExternalDescription);
                public static string ExternalExample => "S.SettingsPage.CreateAsset.ExternalExample".GetStringResource(@"Example: large files such as assets in a package release");
                private static IObservable<string>? _ExternalExampleObservable;
                public static IObservable<string> ExternalExampleObservable => _ExternalExampleObservable ??= "S.SettingsPage.CreateAsset.ExternalExample".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.ExternalExample);
                public static string PleaseEnterAtLeastOneHashValue => "S.SettingsPage.CreateAsset.PleaseEnterAtLeastOneHashValue".GetStringResource(@"Please enter at least one hash value.");
                private static IObservable<string>? _PleaseEnterAtLeastOneHashValueObservable;
                public static IObservable<string> PleaseEnterAtLeastOneHashValueObservable => _PleaseEnterAtLeastOneHashValueObservable ??= "S.SettingsPage.CreateAsset.PleaseEnterAtLeastOneHashValue".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.PleaseEnterAtLeastOneHashValue);
                public static string UploadingFiles => "S.SettingsPage.CreateAsset.UploadingFiles".GetStringResource(@"Uploading files.");
                private static IObservable<string>? _UploadingFilesObservable;
                public static IObservable<string> UploadingFilesObservable => _UploadingFilesObservable ??= "S.SettingsPage.CreateAsset.UploadingFiles".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.UploadingFiles);
                public static string PerformingAnOperation => "S.SettingsPage.CreateAsset.PerformingAnOperation".GetStringResource(@"Performing an operation.");
                private static IObservable<string>? _PerformingAnOperationObservable;
                public static IObservable<string> PerformingAnOperationObservable => _PerformingAnOperationObservable ??= "S.SettingsPage.CreateAsset.PerformingAnOperation".GetStringObservable(global::Beutl.Language.Resources.S.SettingsPage.CreateAsset.PerformingAnOperation);
